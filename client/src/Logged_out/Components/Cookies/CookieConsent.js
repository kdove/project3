  ...
  return (
    <Snackbar
      ...
      action={
        <Fragment>
          <Box mr={1}>
            <Button color="primary" className="text-gold" onClick={handleCookieRulesDialogOpen}>
              More details
            </Button>
          </Box>
          <Button color="primary" className="text-blue" onClick={onAccept}>
            Accept
          </Button>
        </Fragment>
      }
